...
public class ProductServiceImpl implements ProductServices {
    ...
    private final ProductRepository productRepositoryObj;
    ...
    public Product getProduct(Long id) {
        return productRepositoryObj.findById(id).orElse(null);
    }
    ...
    public Product updateProduct(Product product) {
        ...
        return productRepositoryObj.save(productDB);
    }
    ...
    public List<Product> findByCategory(Category category) {
        return productRepositoryObj.findAllByCategory(category);
    }
